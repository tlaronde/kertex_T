% This is webmergedHUGE.ch, a WEB change file produced by webmerge.tex
...
@y
@!mem_max=4194302; {greatest index in \MP's internal |mem| array;
  must be strictly less than |max_halfword|;
  must be equal to |mem_top| in \.{INIMP}, otherwise |>=mem_top|}
...
@!mem_top=4194302; {largest index in the |mem| array dumped by \.{INIMF};
