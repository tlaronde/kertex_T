% This is webmergedSELLETTE.ch, a WEB change file produced by webmerge.tex
% to be applied to /data/src/knuth/tex/tex.web
% combining the changes (one after the other) from
% 1. ../../tex/bin1/filename.ch
% 2. /data/src/etex/etex.ch
% 3. prote.ch
% 4. ../../tex/bin1/kertex_common.ch
% 5. kertex.ch
% 6. ../../tex/bin1/TRIP.ch
% 7. SELLETTE.ch
...
@!string_vacancies=8000; {the minimum number of characters that should be
  available for the user's control sequences and font names,
  after \TeX's own error messages are stored}
@!pool_size=52000; {maximum number of characters in strings, including all
  error messages and help texts, and the names of all fonts and
  control sequences; must exceed |string_vacancies| by the total
  length of \TeX's own strings, which is currently about 23000}
@!save_size=600; {space for saving values outside of current group; must be
