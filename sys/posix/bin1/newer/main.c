...
/* It is POSIX.1 while METAFONT/TeX/MetaPost are C89. But if
   `find -newer' is POSIX.2, find(1) is not to be found on Plan9.
   Hence this utility used by auxiliary scripts for MetaPost, for
   optimization... i.e. it is dispensable. [TL 2011-04-11]
 */
int
